<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PermisosModulosRoles.aspx.cs" Inherits="Suite.Web.Seguridad.forms.PermisosModulosRoles" MasterPageFile="../MasterPage.Master" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" >
        <ContentTemplate>
            <div  class="CatalogTitle" style="text-align: center" >
                 <dx:ASPxLabel ID="lblTitulo" runat="server" Text="Permisos Modulos Roles" ></dx:ASPxLabel>
            </div>
            <table width="1000px">
                <tr>
                    <td width="70px">
                    ...
                    <td colspan="7" >
                        <asp:Panel ID="Panel1" runat="server" ScrollBars="Horizontal" Width="995px">
                             <dx:ASPxTreeList ID="TreeListPermisosModulos" runat="server" AutoGenerateColumns="False"  
                                Caption="Módulos" Width="995px" KeyFieldName="idModulo" ParentFieldName="Padre"
                                DataSourceID="EntityDataSourcePermisosRoles"
                                ...
                                <Templates>
                                    <EditForm>
                                        <asp:Panel ID="Panel2" runat="server">
                                            <asp:TextBox runat="server" ID="txtIdRolPermisos" Visible="false" Text= '<%# Eval("idRolPermiso") %>'>'></asp:TextBox>
                                            <table width="100%"> 
                                                <tr>
                                                    <td align="left"> 
                                                ...
                                                <tr>
                                                    <td align="left"> 
                                                        <asp:CheckBox ID="chkForzarPermisos" runat="server" TextAlign="Right" Visible="true" Text="  Forzar Cambios Permisos Usuarios" Height="25px" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="left"> 
		                        ...
		                        <Columns>   
                                    ...
                                    <dx:TreeListTextColumn Caption="idRolPermiso" FieldName="idRolPermiso" 
            ...
            <asp:EntityDataSource ID="EntityDataSourcePermisosRoles" runat="server" 
	             ConnectionString="name=Seguridad2017Entities" 
	             DefaultContainerName="Seguridad2017Entities" EnableFlattening="False" 
                 Select="it.[Descripcion], it.[Padre], it.[idRolPermiso], it.[idRol], it.[idAplicacion], it.[idModulo], 
			            it.[Visualizar], it.[Agregar], it.[Modificar], it.[Eliminar], it.[Especial]"
	             CommandText=" SELECT T.Descripcion, T.Padre, T.idRolPermiso, T.idRol, T.idAplicacion, T.idModulo, 
                    T.Visualizar, T.Agregar, T.Modificar, T.Eliminar, T.Especial 
                    FROM (SELECT A.Descripcion,
                        A.Padre,
                        (CASE WHEN B.idRolPermisos IS NULL THEN -1 ELSE B.idRolPermisos END) AS idRolPermiso,
                        B.idRol, 
                        A.idAplicacion, 
                        A.idModulo, 
                    ...
                    FROM Modulos AS A
                    LEFT JOIN RolesPermisos AS B ON A.idModulo = B.idModulo AND B.idRol = @idRol
                    WHERE A.idAplicacion = @idAplicacion AND A.Eliminado = False) AS T 
                    WHERE (@idRolPermiso = -1 AND T.idRolPermiso = @idRolPermiso) 
                    OR (@idRolPermiso = 0 AND T.idRolPermiso> @idRolPermiso) OR (@idRolPermiso = -2 AND T.idRolPermiso > @idRolPermiso) AND (@ParametroCodigoDesc IS NULL OR (T.Descripcion LIKE '%' + @ParametroCodigoDesc + '%'))"
	             ContextTypeName="Seguridad.Model.Seguridad2017Entities">  
                 <CommandParameters >
                    <asp:ControlParameter ControlID="ASPxComboBoxAplicaciones" DbType="Int32" Name="idAplicacion" PropertyName="Value" />
                    <asp:ControlParameter ControlID="cmbActivos" DbType="Int32" Name="idRolPermiso" PropertyName="Value" />
